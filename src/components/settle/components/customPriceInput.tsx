...
const CustomPriceInput: React.FC<SuccessViewProps> = ({
    ...
    return(
        <div className="mb-3 md:mb-6 animate-fade-in">
            <label className="text-[10px] md:text-xs font-bold text-gray-500 uppercase mb-2 block">{getInfo()} (SOL)</label>
            <div className="relative group">
                ...
                <input 
                    ...
                    className="w-full bg-white/5 border-[2px] border-white/10 rounded-xl py-3 md:py-4 pl-12 pr-4 text-[17px] md:text-xl font-mono font-bold text-white focus:outline-none focus:border-[#B4FC75]/50 focus:bg-white/[0.08] transition-all"
                    placeholder="0.00"
                />
            </div>
        </div>
