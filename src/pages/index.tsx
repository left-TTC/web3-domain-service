...
const Index: React.FC<IndexProps> = ({
    ...
    return(
        <div onClick={() => {console.log(referrer)}} className="min-h-screen bg-[#050505] text-white selection:bg-[#B4FC75] selection:text-black pb-24 px-5 sm:px-10 relative overflow-x-hidden">
            ...
            <div className="h-[300px] flex items-center justify-center border-b border-white/5 mt-[30px] sm:mt-[150px]">
                <div className="text-center">
                    <h3 className="text-[60px] sm:text-[120px] font-black italic tracking-tighter mb-4 opacity-10">KILO HUB</h3>
                    <p className="text-gray-500 tracking-[0.5em] uppercase text-[12px] sm:text-sm font-normal">向下滚动探索新工具</p>
                </div>
            </div>
            <DownloadKilo />
